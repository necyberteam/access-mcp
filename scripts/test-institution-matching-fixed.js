...
// Test cases
const testInstitutions = ["Stanford University", "University of Colorado Boulder"];
...
if (
  totalMatches["Stanford University"].length === 1 &&
...
if (
  totalMatches["University of Colorado Boulder"].length === 1 &&
