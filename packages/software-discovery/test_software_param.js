...
async function testSoftwareParameter() {
  ...
  try {
    ...
    if (response1.status === 200) {
      console.log(
        `Success! Found ${Array.isArray(response1.data) ? response1.data.length : 0} results`
      );
      if (Array.isArray(response1.data) && response1.data.length > 0) {
        console.log(
          `Sample result: ${JSON.stringify(response1.data[0], null, 2).substring(0, 500)}...\n`
        );
      }
    } else {
  ...
  try {
    ...
    if (response2.status === 200) {
      console.log(
        `Success! Found ${Array.isArray(response2.data) ? response2.data.length : 0} results`
      );
      if (Array.isArray(response2.data) && response2.data.length > 0) {
        console.log(
          `Sample result: ${JSON.stringify(response2.data[0], null, 2).substring(0, 500)}...\n`
        );
      }
    } else {
  ...
  try {
    ...
    if (response3.status === 200) {
      console.log(
        `Success! Found ${Array.isArray(response3.data) ? response3.data.length : 0} results`
      );
      if (Array.isArray(response3.data) && response3.data.length > 0) {
        console.log(
          `Sample result: ${JSON.stringify(response3.data[0], null, 2).substring(0, 500)}...\n`
        );
      }
    } else {
  ...
  try {
    ...
    if (response4.status === 200) {
      console.log(
        `Success! Found ${Array.isArray(response4.data) ? response4.data.length : 0} results`
      );
      if (Array.isArray(response4.data) && response4.data.length > 0) {
        console.log(
          `Sample result: ${JSON.stringify(response4.data[0], null, 2).substring(0, 500)}...\n`
        );
      }
    } else {
  ...
  try {
    ...
    if (response5.status === 200) {
      console.log(
        `Success! Found ${Array.isArray(response5.data) ? response5.data.length : 0} results`
      );
      if (Array.isArray(response5.data) && response5.data.length > 0) {
        console.log(
          `Sample result: ${JSON.stringify(response5.data[0], null, 2).substring(0, 500)}...\n`
        );
      }
    } else {
  ...
  try {
    ...
    if (response6.status === 200) {
      console.log(
        `Success! Found ${Array.isArray(response6.data) ? response6.data.length : 0} results`
      );
      if (Array.isArray(response6.data) && response6.data.length > 0) {
        console.log(
          `Sample result: ${JSON.stringify(response6.data[0], null, 2).substring(0, 500)}...\n`
        );
      }
    } else {
